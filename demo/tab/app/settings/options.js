...
cas_companion.options.addTab('General', [
    ...
    { name: 'cas_server_url', 'default': 'http://localhost', type: 'text', desc: 'The url for CAS Service' },
    { name: 'cas_server_token', 'default': 'cCWcsOsxprO2BhnUnondjSqBLzPk1dCFf4Bb24JE', type: 'text', desc: 'The CAS access token assigned' },
